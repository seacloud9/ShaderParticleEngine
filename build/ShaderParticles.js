...
this.shaderParticleUtils = {
    ...
    randomVector3OnSpiral: function( emitter ){
        ...
        emitter._randomizeExistingVector3OnSpiral(vec, emitter.position, emitter.radius, emitter.radiusSpread, emitter.radiusScale, emitter.radiusSpreadClamp, emitter.radiusMax, emitter.spiralSkew, emitter.spiralRotation);
        return vec;
    },
    ...
    randomVelocityVector3OnSpiral: function( emitter, base ){
        ...
        emitter._randomizeExistingVelocityVector3OnSpiral(direction, base, emitter.position, emitter.speed, emitter.speedSpread, emitter.radiusMax);
        return direction;
    },
